...
const TestimonialCard = ({ image, message, name, role, company }) => {
  return (
    <div
      className={
        "rounded-xl flex-1 items-center justify-center flex flex-col bg-[#e6ce9f] py-8 px-16 text-slate-950 relative gap-4 h-72 mx-2 mb-6"
      }
    >
      <img
        src={image}
      ...
      <img
        src="/images/quot.svg"
        className={
          "z-0 absolute font-light text-[#085585] w-32 h-32 -top-12 left-4"
        }
      />
